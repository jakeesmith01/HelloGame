...
namespace HelloGame
{
    public class Game1 : Game
    {
        ...
        protected override void Initialize() //happens before the graphics device is initialized | good for restarting the game, just call func again
        {
            ...
            _ballVelocity.Normalize(); //mutates value of vector, shortens it

            _ballVelocity *= 100; //scales the velocity

            base.Initialize();
        }

        protected override void LoadContent() //happens after graphics device is initialized
        {
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            _spriteBatch.Begin();
            _spriteBatch.Draw(_ballTexture, _ballPosition, Color.White); //white keeps it the same as the base image
            _spriteBatch.End();
